...
from t5_GenerateRankModel import MyT5ForSequenceClassificationAndGeneration, ABC
from transformers.models.mbart.modeling_mbart import shift_tokens_right
from transformers import T5Tokenizer, AutoTokenizer
from transformers import (CONFIG_NAME, T5Config,
...
def train(args, tokenizer, device):
    ...
    model = MyT5ForSequenceClassificationAndGeneration(modelpath = args.model_path,
                                                       config=config,
